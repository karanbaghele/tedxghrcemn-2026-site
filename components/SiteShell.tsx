...
function Home() {
  return <>
    ...
    <main id="main-content">
      ...
      <section className="section activity-home"><PhotoVisual src="/gallery/audience-06.jpg" alt="Audience members engaged in a TEDxGHRCEMN session" className="activity-visual" /><div><SectionIntro label="PRE-FEST / 04" title={<>Ideas become<br /><em>practice.</em></>} copy="Two confirmed Pre-Fest experiences take place at GHRCEMN on 8 September 2026." />{activities.map((a,i)=><a className="activity-row" href={a.registrationUrl} target="_blank" rel="noreferrer" key={a.title}><span>0{i+1}</span><div><p className="eyebrow">{a.category}</p><h3>{a.title}</h3><p>{a.dateTime} • {a.price}</p></div><ArrowRight /></a>)}</div></section>
...
function EventPage(){return <main id="main-content"><PageHero label="EVENT / TWO DAYS" title="From practice to perspective" copy="Two in-person Pre-Fest experiences followed by the paid TEDxGHRCEMN Main Event."/><section className="facts"><div><CalendarDays/><span>Main Event</span><strong>{siteConfig.date}</strong><small>Wednesday</small></div><div><Clock3/><span>Timings</span><strong>9:00 AM–6:00 PM</strong><small>India Standard Time</small></div><div><MapPin/><span>Venue</span><strong>GHRCEMN, Nagpur</strong><small>{siteConfig.mode}</small></div><div><ExternalLink/><span>Passes</span><strong>From ₹399</strong><small>Register on KonfHub</small></div></section><section className="section event-days"><article><PhotoVisual src="/gallery/community-02.jpg" alt="Participants and organisers gathered at TEDxGHRCEMN" className="event-day-photo" /><p className="eyebrow">8 SEPTEMBER • PRE-FEST</p><h2>Make, test, question.</h2><p>Two confirmed paid experiences invite participants to experiment before the main stage opens.</p><ul><li>Beyond Build: 10:00 AM–6:00 PM</li><li>AI in Development &amp; Design: 11:00 AM–3:00 PM</li><li>Venue: GHRCEMN, Nagpur</li><li>Tickets: ₹99 each</li></ul><a className="text-link" href="/activities">View both activities <ArrowRight size={17}/></a></article><article><PhotoVisual src="/gallery/stage-07.jpg" alt="A speaker presenting on the TEDxGHRCEMN stage" className="event-day-photo" /><p className="eyebrow">9 SEPTEMBER • MAIN EVENT</p><h2>Listen, reflect, connect.</h2><p>TEDx talks, audience engagement and meaningful conversation in one focused programme.</p><ul><li>Time: 9:00 AM–6:00 PM IST</li><li>Early Bird: ₹399</li><li>Regular Pass: ₹449</li><li>Venue: GHRCEMN, Nagpur</li></ul><RegisterButton label="Register for Main Event" /></article></section><Schedule/></main>}
